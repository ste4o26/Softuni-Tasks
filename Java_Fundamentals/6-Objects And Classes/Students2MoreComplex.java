...
public class Students2MoreComplex {
    ...
    static void fillStudentList(List<Student> studentsList, Scanner sc) {
        ...
        while (!input.equalsIgnoreCase("end")) {
            ...
            for (int i = 0; i < studentsList.size(); i++) {
                boolean isSameFirstName = student.getFirstName().equals(studentsList.get(i).getFirstName());
                boolean isSameLastName = student.getLastName().equals(studentsList.get(i).getLastName());
